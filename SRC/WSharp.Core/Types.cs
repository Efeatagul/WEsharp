...
namespace WSharp
{
    ...
    public class Environment
    {
        ...
        public IReadOnlyDictionary<string, WValue> Values => _values;
        ...
        public WValue GetByName(string name)
        {
            if (_values.ContainsKey(name)) return _values[name];
            if (Enclosing != null) return Enclosing.GetByName(name);
            throw new Exception($"Tanimsiz degisken: '{name}'.");
        }

        
        public Dictionary<string, WValue> GetAllDefinitions()
        {
            return new Dictionary<string, WValue>(_values);
        }
    }
    ...
    public class WFunction : IWCallable
    {
        ...
        public FunctionStmt Declaration => _declaration;
    ...
    public class WLambda : IWCallable
    {
        ...
        public LambdaExpr Expr => _declaration;
        ...
        public WValue Call(Interpreter interpreter, List<WValue> arguments)
        {
            ...
            if (_declaration.Body is ExpressionStmt exprStmt)
            {
                ...
                return interpreter.EvaluateIn(exprStmt.Expression, environment);
            }
