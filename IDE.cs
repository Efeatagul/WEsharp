    ...
    public class IDE : Form
    {
        ...
        private void SetupGridSystem()
        {
            ...
            Label lblTitle = new Label
            {
                ...
                Dock = DockStyle.Top,
                Height = splitColCenter.Panel1.Height / 2
            };

            Label lblCommands = new Label
            {
                Text = "New File: Ctrl+N    |    Save: Ctrl+S    |    Run: F5",
        ...
        private void RunCode()
        {
            ...
            terminalArea.AppendText($"wsharp-cli build --target \"{editorTabs.SelectedTab?.Text ?? "script.we"}\"\n");
